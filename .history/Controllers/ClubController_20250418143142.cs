...
namespace SportClubApi.Controllers
{
    ...
    [ApiController]
    public class ClubController(ApplicationContext context, ClubMapper clubMapper) : ControllerBase
    {
        private readonly ApplicationContext _context = context;
        private readonly ClubMapper _clubMapper = clubMapper;
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Club>> PostClub(ClubDtoCreate clubDto)
        {
            var club = _clubMapper.ToDtoCreate(clubDto);
            _context.Clubs.Add(_clubMapper.ToDtoCreate(clubDto));
            await _context.SaveChangesAsync();
